...
/def uzinews = \
    ...
    /else \
        /echo -p %htxt2 New features in Uzi $(/uziver) you should try%;\
	...
	/echo -p %htxt2 - Improved nightblade support.%;\
        ...
        /echo -p %htxt  - New Releases at :  http://www.lysator.liu.se/~moe/burning/%;\
        /echo -p %htxt  - Report bugs at  :  http://uzi-tf.no-ip.org/%;\
    /endif
